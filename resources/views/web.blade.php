...
<div id="preloader" class="preloader" data-delay="0" data-limit="3000">
    <x-webp-image src="{{ asset('images/ORCALogo PNG.png') }}" class="emblem" alt="Emblem" hidden="hidden" />
</div>
<style>
    .megamenuimg {
...
<body class="shock-body publicationbody">
        ...
        <nav id="navbar" class="navbar navbar-expand-lg fixed-scroll hover-line-center scheme-1 primary">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('https://orcasia.org') }}">
                    <x-webp-image src="{{ asset('images/ORCA Website Banner Logo PNG.png') }}" alt="ORCA"
                                ...
                                <div class="form-row row has-icon">
                                    <div class="form-col mb-0 form-floating">
                                        <button class="button overlay-button"><x-webp-image class="overlay-image-icon"
                                                src="{{ asset('svg/send-outline.svg') }}" alt="Icon name"
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="megamenu-item has-side-image image-absolute-right">
                                                    <a href="{{ url('pages/team') }}" class="megamenu-image black">
                                                        <x-webp-image src="{{ asset('images/teampic.jpeg') }}"
                                    ...
                                    <div class="section-inner-expanded">
                                        <div class="row">
                                            ...
                                            foreach ($categories as $catId) {
                                                $article = App\Models\Article::select('id', 'author_id', 'category', 'read_time', 'title', 'slug', 'subtitle', 'title_image', 'created_at')->where('category', $catId)->where('status', 'approved')->orderBy('created_at', 'desc')->first(); // fetch only the latest one
                                                    ...
                                                    <div class="megamenu-item">
                                                        <div
                                                            ...
                                                            <div class="image-wrapper hover-up-down">
                                                                <x-webp-image
                                                                    src="{{ asset('images/article/' . $article->title_image) }}"
                                                                    alt="Image name" class="image" />
                                                            </div>
                                                            <!-- Body -->
                                    ...
                                    <div class="section-inner-expanded">
                                        <div class="horizontal-tab scheme-1 primary">
                                            ...
                                            <ul id="elements-tab" class="nav nav-tabs js-tabs-event" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-6-tab" class="title nav-link"
                                                        aria-selected="true" aria-controls="elements-6"
                                                                            ...
                                                                            <div class="bricklayer-column"
                                                                                ...
                                                                                <div class="image-wrapper shadow rounded"
                                                                                    ...
                                                                                    <div class="overlay black-50"
                                                                                        bis_skin_checked="1"></div>
                                                                                    <x-webp-image
                                                                                        src="{{ asset('images/jpg/dashboard1.png') }}"
                                                                                        class="image"
                                                                            ...
                                                                            <div class="bricklayer-column"
                                                                                ...
                                                                                <div class="image-wrapper shadow rounded"
                                                                                    ...
                                                                                    <div class="overlay black-50"
                                                                                        bis_skin_checked="1"></div>
                                                                                    <x-webp-image
                                                                                        src="{{ asset('images/jpg/dashboard2.png') }}"
                                                                                        class="image"
                                                                                        alt="India China Trade Dashboard" />
                                                                                </div>
                                                                                <a href="{{ url('pages/china-census-dashboard') }}"
                                                                            ...
                                                                            <div class="bricklayer-column"
                                                                                ...
                                                                                <div class="image-wrapper shadow rounded"
                                                                                    ...
                                                                                    <div class="overlay black-50"
                                                                                        bis_skin_checked="1"></div>
                                                                                    <x-webp-image
                                                                                        src="{{ asset('images/jpg/dashboard3.png') }}"
                                                                                        class="image"
                                                                                        alt="India China Trade Dashboard" />
                                                                                </div>
                                                                                <a href="{{ url('pages/china-provinces-dashboard') }}"
                                                                            ...
                                                                            <div class="bricklayer-column"
                                                                                ...
                                                                                <div class="image-wrapper shadow rounded"
                                                                                    ...
                                                                                    <div class="overlay black-50"
                                                                                        bis_skin_checked="1"></div>
                                                                                    <x-webp-image
                                                                                        src="{{ asset('images/jpg/dashboard4.png') }}"
                                                                                        class="image"
                                                                                        alt="India China Trade Dashboard" />
                                                                                </div>
                                                                                <a href="{{ url('pages/china-public-diplomacy-dashboard') }}"
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="image-wrapper shadow rounded"
                                                                ...
                                                                <x-webp-image
                                                                    src="{{ asset('images/Popuppanel.jpeg') }}"
                                                                    class="image"
                                                                    alt="India China Trade Dashboard" />
                                                            </div>
                                                        </div>
                                                ...
                                                <div id="elements-6" class="tab-pane fade" role="tabpanel">
                                                    <div class="row g-3">
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                <h6 class="title"><a
                                                                        href="{{ url('category/special-report') }}"
                                                                        style="color: inherit;">Special Reports</a>
                                                                </h6>
                                                                <ul class="nav-list list-unstyled">
                                                                    @php
                                                                        $count = 0;
                                                                        $sprs = App\Models\Article::select(
                                                                            'id',
                                                                            'title',
                                                                            'subtitle',
                                                                            'slug',
                                                                    ...
                                                                    @foreach ($sprs as $spr)
                                                                        <li class="nav-item">
                                                                            <a href="{{ url('specialreport/' . $spr->slug) }}"
                                                                                class="nav-link parent"
                                                                                style="overflow-wrap: break-word; white-space: normal;">
                                                                                <span
                                                                                    class="text">{{ $spr->title }}</span>
                                                                            </a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                        ...
                                                        @foreach ($sprs as $spr)
                                                            <div class="col-12 col-md-6 col-lg-4">
                                                                ...
                                                                if($count == 2) {                                                           
                                                            ?>
                                                                <a href="{{ url('category/special-report') }}"
                                                                    style="margin-top: 15px;justify-content: flex-end;display: flex;">Read
                                                                    More</a>
                                                                <?php } ?>
                                                            </div>
                                                        @endforeach
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="megamenu-item">
                                        ...
                                        foreach ($tags as $tag) {
                                            echo '<a href="' . route('tag.show', ['slug' => $tag->slug]) . '" class="link">                                                                                                                                                                                                                                      <span class="badge-text gray white-hover">' . $tag->tag . '</span>                                                                                                                                                                                                                                      </a>';
                                        }
                                        echo '</div>';
                                        ?>
                                    </div>
                                            ...
                                            <form action="{{ url('search') }}" method="post"
                                                ...
                                                <div class="form-row row has-icon">
                                                    <div class="form-col form-floating">
                                                        <button type="submit"
                                                            class="button overlay-button"><x-webp-image
                                                                class="overlay-image-icon"
                                                                src="{{ asset('svg/send-outline.svg') }}"
    ...
    <section class="shock-section has-overlay pt-5 pb-5 bg-image bg-fixed hidden-print"
        data-bg-image="{{ asset('images/jpg/sub.jpeg') }}">
    ...
    <footer id="footer" class="shock-footer scheme-1 primary">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="footer-item">
                            ...
                            <a href="#" class="footer-brand">
                                ...
                                <x-webp-image src="{{ asset('images/whiteORCA Website Banner Logo PNG.png') }}"
                                ...
                                <ul class="icon-h-list">
                                    <li class="item ms-0">
                                        <a href="https://orcasia.substack.com/"
                                            class="link gray primary-hover hover-rotate"><x-webp-image
                                                class="substacksymbol"
                                                src="{{ asset('svg/substack-logo.svg') }}" /></a>
                                    </li>
        ...
        <div class="bottom-bar">
            <div class="text">ORCA © {{ now()->year }} - All rights reserved.</div>
        </div>
    </footer>
    <!-- Cursor -->
    ...
    <script src="{{ asset('js/vendor/menu-engine.min.js') }}"></script>
    <script src="{{ asset('js/vendor/menu-grid.min.js') }}"></script>
    <script src="{{ asset('js/vendor/bootstrap.min.js') }}"></script>
    <script src="{{ asset('js/vendor/swiper.min.js') }}"></script>
    <script src="{{ asset('js/vendor/anime.min.js') }}"></script>
    <script src="{{ asset('js/vendor/dynamic-slider.min.js') }}"></script>
    <script src="{{ asset('js/vendor/shuffle.min.js') }}"></script>
    <script src="{{ asset('js/vendor/stickybits.min.js') }}"></script>
    <script src="{{ asset('js/vendor/bricklayer.min.js') }}"></script>
    <script src="{{ asset('js/vendor/lightbox.min.js') }}"></script>
    <script src="{{ asset('js/vendor/typed.min.js') }}"></script>
    <script src="{{ asset('js/vendor/progressbar.min.js') }}"></script>
    <script src="{{ asset('js/vendor/map-styles.min.js') }}"></script>
    <script src="{{ asset('js/vendor/magnetic-effect.min.js') }}"></script>
    <script src="{{ asset('js/vendor/gsap.min.js') }}"></script>
    <script src="{{ asset('js/vendor/aos.min.js') }}"></script>
    <script src="{{ asset('js/vendor/lax.min.js') }}"></script>
    <script src="{{ asset('js/vendor/cursor-effect.min.js') }}"></script>
    <!-- Main JavaScript -->
