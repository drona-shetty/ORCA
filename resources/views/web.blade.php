                                ...
                                <div class="container">
                                    <div class="section-inner-expanded">
                                        <div class="row">
                                            ...
                                            <?php
                                            //$categories = [20, 23, 26, 18, 22, 21, 36];
                                            $categories = [20, 23, 26];
                                            $latest_articles = collect();

                                            foreach ($categories as $catId) {
                                                $article = App\Models\Article::select(
                                                    'id', 'author_id', 'category', 'read_time', 'title', 'slug', 
                                                    'subtitle', 'title_image', 'created_at'
                                                )
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="footer-item">
                            ...
                            <ul class="nav-list list-unstyled">
                                @php
                                    $events = App\Models\Article::select('id', 'slug', 'title', 'created_at')
                                        ->where('category', 31)
                                        ->orderBy('created_at', 'desc')
                                        ->limit(3)
                                        ->get();
