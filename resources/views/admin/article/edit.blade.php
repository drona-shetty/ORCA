            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" id="article" enctype="multipart/form-data" method="POST"
                        action="{{ url("yn-admin/articles/{$article->id}") }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select" id="author_multiSelect" name="author_id[]" required=""
                                multiple>
                        ...
                        <div>
                            <h4>Only for Special Reports</h4>
                        </div>

                        <div class="col-12 col-md-6">
                            <label for="p_color" class="form-label">Paragraph Text Color</label>
                            <input type="color" class="form-control form-control-color" id="p_color" name="p_color"
                                value="{{ $article->p_color ?? '#ffffff' }}">
                        </div>

                        <div class="col-12 col-md-6">
                            <label for="a_color" class="form-label">Link / Accent Color</label>
                            <input type="color" class="form-control form-control-color" id="a_color" name="a_color"
                                value="{{ $article->a_color ?? '#e41e25' }}">
                        </div>

                        <div class="col-12 col-md-6">
                            <label for="section_bg" class="form-label">Section & Overlay Background Color</label>
                            <input type="color" class="form-control form-control-color" id="section_bg"
                                name="section_bg" value="{{ $article->section_bg ?? '#000000' }}">
                        </div>
