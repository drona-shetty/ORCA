...
<main id="main" class="main">
    ...
    <input type="color" class="form-control form-control-color" id="p_color" name="p_color" value="#ffffff">
</div>

<div class="col-12 col-md-6">
    <label for="a_color" class="form-label">Background Color</label>
    <input type="color" class="form-control form-control-color" id="a_color" name="a_color" value="#e41e25">
</div>

<div class="col-12 col-md-6">
    <label for="section_bg" class="form-label">Section & Overlay Start Color</label>
