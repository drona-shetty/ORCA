    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="row g-3" enctype="multipart/form-data" method="POST" action="{{url('yn-admin/gcns26/media')}}">
                    @csrf
                    ...
                    <tbody>
                        @foreach ($mediaFiles as $media)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('yn-admin/gcns/media') }}/{{ $media['id'] }}/edit" class="btn btn-primary rounded-pill btn-sm">Edit</a>
                                    <button data-bs-toggle="modal" data-id="{{$media['id']}}" data-aurl="{{ url('check-category') }}" data-url="{{ url('yn-admin/gcns/media/'.$media['id']) }}"
