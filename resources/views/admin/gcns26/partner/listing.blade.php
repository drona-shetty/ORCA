    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="row g-3" enctype="multipart/form-data" method="POST" action="{{url('yn-admin/gcns26/partner')}}">
                    @csrf
                    ...
                    <tbody>
                        @foreach ($partners as $partner)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('yn-admin/gcns/partner') }}/{{ $partner->id }}/edit" class="btn btn-primary rounded-pill btn-sm">Edit</a>
                                    <button data-bs-toggle="modal" data-id="{{$partner->id}}" data-aurl="{{ url('check-category') }}" data-url="{{ url('yn-admin/gcns/partner/'.$partner->id) }}"
