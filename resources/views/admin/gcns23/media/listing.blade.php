    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="row g-3" enctype="multipart/form-data" method="POST" action="{{url('yn-admin/gcns23/media')}}">
                    @csrf
                    ...
                    <tbody>
                        @foreach ($mediaFiles as $media)
                            <tr>
                                ...
                                <td>
                                    <img class="" style="height:100px;width:100px;" src="{{url('images/event/media/'.$media['files'])}}" width="100" height="100" alt="">
                                </td>
                                <td>
                                    <a href="{{ url('yn-admin/gcns23/media') }}/{{ $media['id'] }}/edit" class="btn btn-primary rounded-pill btn-sm">Edit</a>
                                    <button data-bs-toggle="modal" data-id="{{$media['id']}}" data-aurl="{{ url('check-category') }}" data-url="{{ url('yn-admin/gcns23/media/'.$media['id']) }}"
