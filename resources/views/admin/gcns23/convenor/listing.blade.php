    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="row g-3" enctype="multipart/form-data" method="POST" action="{{url('yn-admin/gcns23/convenors')}}">
                    @csrf
                    <input type="hidden" name="gcns" value="2023">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($convenor->logo != null)
                                        <img style="width:100px;" src="{{url('images/event/convenor/'.$convenor->logo)}}" alt="">
                                    @else
                                        {{'-'}}
                                    @endif
                                </td>
