            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-6" style="text-align: right;">
                        <a href="{{ url('yn-admin/gcns23/schedule') }}/{{ $schedule->id }}/edit" type="button"  class="btn btn-primary ">Back</a>
                    </div>
                </div>
                @if ($errors->any())
                ...
                @endif
                <form class="row g-3" enctype="multipart/form-data" method="POST" action="{{ url('yn-admin/gcns23/schedule') }}/{{ $schedule->id }}/{{$sessionData->id}}/sessionUpdate">
                    @csrf
                    @method('PUT')
