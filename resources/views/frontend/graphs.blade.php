...
@section('content')
    ...
    <section class="shock-section has-overlay bg-image bg-fixed"
        data-bg-image="{{ asset('images/AdobeStock_599518432.jpg') }}">
                ...
                <div class="card">
                    <a href="#" data-bs-toggle="modal"
                        ...
                        <div class="image-wrapper small-shadow rounded-top">
                            <x-webp-image src="{{ asset('images/graph/' . $graph->image) }}" class="image"
                                ...
                                <div class="col-12 col-md-7 align-v-center">
                                    <div class="holder">
                                        ...
                                        <div class="mt-social-1 mt-1">
                                            ...
                                            <a href="{{ asset('images/graph/' . $graph->image) }}"
                                ...
                                <div class="col-12 col-md-5">
                                    ...
                                    <div class="image-wrapper" data-lax="inertia-top">
                                        <x-webp-image style="border-radius: 0.375rem;"
                                            src="{{ asset('images/graph/' . $graph->image) }}" class="image"
                                            alt="Image name" />
                                    </div>
                                </div>
                            </div>
