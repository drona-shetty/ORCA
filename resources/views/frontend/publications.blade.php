            ...
            @foreach($opinionArticles as $article)
                <div class="col-12 col-md-6 col-lg-4 load-more-item-2">
                    <div class="card has-full-image vh-65 small-shadow rounded parent">
                        ...
                        <x-webp-image src="{{asset('images/article/'.$article->title_image)}}" alt="Image name" class="image" />
                        </div>
                        <!-- Body -->
        ...
        <div class="row g-0">
          ...
          <div class="col-12 col-lg-7">
            <div class="card has-full-image is-featured-left small-shadow rounded parent">
              ...
              <!-- Image -->
              <div class="image-wrapper hover-up-down">
                <x-webp-image src="{{asset('images/article/'.$issueArticles[0]->title_image)}}" alt="Image name" class="image" />
              </div>
              <!-- Body -->
              <div class="card-body align-v-bottom">
                <div class="holder">
          ...
          <div class="col-12 col-lg-5">
            <div class="card has-full-image is-featured-right small-shadow rounded parent">
              <!-- Image -->
              <div class="image-wrapper hover-up-down">
                <x-webp-image src="{{asset('images/article/'.$issueArticles[1]->title_image)}}" alt="Image name" class="image" />
              </div>
              <!-- Body -->
              <div class="card-body align-v-bottom">
                <div class="holder">
            ...
            <div class="card has-full-image is-featured-right small-shadow rounded parent">
              <!-- Image -->
              <div class="image-wrapper hover-up-down">
                <x-webp-image src="{{asset('images/article/'.$issueArticles[2]->title_image)}}" alt="Image name" class="image" />
              </div>
              <!-- Body -->
              <div class="card-body align-v-bottom">
                <div class="holder">
