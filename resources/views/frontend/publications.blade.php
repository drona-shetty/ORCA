                                ...
                                <div class="holder">
                                    <a href="{{ url('category/' . $opinionCategory->slug) }}" class="link">
                                        <span class="badge outline primary primary-hover">
                                            <span
                                                class="badge-text white-75 white-hover">{{ $opinionCategory->category }}</span>
                                        </span>
                                    </a>
                                        ...
                                        <div class="item">
                                            <a href="{{ url('author/' . $author_meta->slug) }}"
                                                class="link gray primary-hover"><i
                                                    class="fa-solid fa-user icon"></i>{{ $author->name }}
                                            </a>
                                        </div>
                                        <div class="item">
                        ...
                        <div class="card has-image shadow parent">
                            ...
                            <span class="label-vertical to-bottom-right-out">
                                ...
                                <a href="{{ url('author/' . $author_meta->slug) }}" class="link">
                                    <span class="label-text gray"><i
                                            class="icon fas fa-user-circle"></i>{{ $author->name }}</span>
                                </a>
                            </span>
                            <!-- Image -->
                            ...
                            <div class="card-body bg-color white">
                                ...
                                <div class="tag-cloud">
                                    ...
                                    <a href="{{ url('category/' . $backgroundersCategory->slug) }}" class="link">
                                        <span class="badge outline gray-50 primary-hover">
                                            <span
                                                class="badge-text gray white-hover">{{ $backgroundersCategory->category }}</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="horizontal-tab mb-3 scheme-2 tertiary">
                ...
                <div class="tab-content">
                    <div id="h-1" class="tab-pane fade show active" role="tabpanel">
                        ...
                        <!-- Posts -->
                        <div class="swiper slider stretched has-gap has-navigation has-pagination scheme-2 tertiary"
                                            ...
                                            <div class="card-body align-v-bottom">
                                                <div class="holder">
                                                    ...
                                                    <div class="card-metadata">
                                                        <div class="item">
                                                            <a href="{{ url('author/' . $author_meta->slug) }}"
                                                                class="link gray tertiary-hover"><i
                    ...
                    <div id="h-2" class="tab-pane fade" role="tabpanel">
                        <p style="text-align:center; color:#fff;" class="pb-2 publicdesc">
                            {{ $cicmInsightCategory->title }}</p>
                        <!-- Posts -->
                        <div class="swiper slider stretched has-gap has-navigation has-pagination scheme-2 tertiary"
                            data-columns="3,2,1,1">
                            <div class="swiper-wrapper">
                                @foreach ($cicmInsightArticles as $article)
                                    <div class="swiper-slide">
                                        <div class="card has-full-image vh-65 small-shadow rounded parent">
                                            ...
                                            <div class="card-body align-v-bottom">
                                                <div class="holder">
                                                    <a href="{{ url('category/' . $cicmInsightCategory->slug) }}"
                                                        class="link">
                                                        <span class="badge tertiary-50 tertiary-hover">
                                                            <span
                                                                class="badge-text white-75 white-hover">{{ $cicmInsightCategory->category }}</span>
                                                        </span>
                                                    </a>
                                                    <a href="{{ url('article/' . $article->id . '/' . $article->slug) }}">
                                                        <h3 class="title text-style-9 white">{{ $article->title }}</h3>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-7">
                    <div class="card has-full-image is-featured-left small-shadow rounded parent">
                        ...
                        <!-- Image -->
                        <div class="image-wrapper hover-up-down">
                            <x-webp-image src="{{ asset('images/article/' . $issueArticles[0]->title_image) }}"
                                alt="Image name" class="image" />
                        </div>
                        <!-- Body -->
                        <div class="card-body align-v-bottom">
                            <div class="holder">
                                ...
                                <div class="card-metadata">
                                    ...
                                    <div class="item">
                                        <a href="#" class="link gray primary-hover"><i
                                                class="fa-solid fa-calendar-days icon"></i><?= date_format(date_create($issueArticles[0]->created_at), 'F j, Y') ?></a>
                                    </div>
                ...
                <div class="col-12 col-lg-5">
                    <div class="card has-full-image is-featured-right small-shadow rounded parent">
                        <!-- Image -->
                        <div class="image-wrapper hover-up-down">
                            <x-webp-image src="{{ asset('images/article/' . $issueArticles[1]->title_image) }}"
                                alt="Image name" class="image" />
                        </div>
                        <!-- Body -->
                        <div class="card-body align-v-bottom">
                            <div class="holder">
                                ...
                                <div class="card-metadata">
                                    <div class="item">
                                        <a href="{{ url('author/' . $author_sec_meta->slug) }}"
                                            class="link gray primary-hover">
                                            <i class="fa-solid fa-user icon"></i>{{ $author_sec->name }}</a>
                                    </div>
                                    <div class="item">
                                        <a href="" class="link gray primary-hover"><i
                                                class="fa-solid fa-calendar-days icon"></i><?= date_format(date_create($issueArticles[1]->created_at), 'F j, Y') ?></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Overlay -->
                    ...
                    <div class="card has-full-image is-featured-right small-shadow rounded parent">
                        <!-- Image -->
                        <div class="image-wrapper hover-up-down">
                            <x-webp-image src="{{ asset('images/article/' . $issueArticles[2]->title_image) }}"
                                alt="Image name" class="image" />
                        </div>
                        <!-- Body -->
                        <div class="card-body align-v-bottom">
                            <div class="holder">
                                ...
                                <div class="card-metadata">
                                    <div class="item">
                                        <a href="{{ url('author/' . $author_thrd_meta->slug) }}"
                                            class="link gray primary-hover">
                                            <i class="fa-solid fa-user icon"></i>{{ $author_thrd->name }}</a>
                                    </div>
                                    <div class="item">
                                        <a href="#" class="link gray primary-hover"><i
                                                class="fa-solid fa-calendar-days icon"></i><?= date_format(date_create($issueArticles[2]->created_at), 'F j, Y') ?></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Overlay -->
