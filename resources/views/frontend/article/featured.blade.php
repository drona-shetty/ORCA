...
@section('content')
    ...
    <!-- Banner -->
    <section class="shock-section bg-image bg-fixed" data-bg-image="{{ asset('images/article/' . $article->title_image) }}">
    ...
    @if ($article->content_image != null && $article->content_image != '')
        <section class="shock-section bg-image bg-fixed"
            data-bg-image="{{ asset('images/article/' . $article->content_image) }}">
            <div class="holder vh-75">&nbsp;</div>
        </section>
    @endif
    <!-- text editor -->
