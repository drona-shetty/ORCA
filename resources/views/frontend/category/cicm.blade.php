        ...
        <div class="container">
            <div class="row g-0">
                    ...
                    <div class="basic-intro text-center mb-35">
                        ...
                        <div class="description gray">
                            ...
                            <p>
                                CiCM Editorial Team:
                                <span>
                                    @foreach (($users ?? collect())->sortBy('name')->take(5) as $user)
                                        @php
                                            $meta = App\Models\UserMeta::where('user_id', $user->id)->first();
                                        @endphp

                                        @if ($meta)
                                            <a href="{{ url('author/' . $meta->slug) }}">
                                                {{ $user->name }}
                                            </a>
                                            @if (!$loop->last)
                                                ,
                ...
                @if (!empty($articles) && isset($articles[0]))
                    @php
                        $featured = $articles[0];
                        $authorIds = @unserialize($featured->author_id);
                        $authorId = is_array($authorIds) ? $authorIds[0] : $featured->author_id;
                        $author = App\Models\User::find($authorId);
                        $authorMeta = $author ? App\Models\UserMeta::where('user_id', $author->id)->first() : null;
                    @endphp
                        ...
                        <div class="card has-full-image is-featured-left small-shadow rounded parent">
                            ...
                            <div class="card-body align-v-bottom">
                                <div class="holder">
                                    ...
                                    <a href="{{ url('article/' . $featured->id . '/' . $featured->slug) }}">
                                    ...
                                    <div class="card-metadata">
                                        ...
                                        <div class="item">
                                            <span class="link gray">
                                                ...
                                                {{ \Carbon\Carbon::parse($featured->created_at)->format('F j, Y') }}
                                            </span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card has-full-image vh-25 small-shadow rounded parent">
                                                ...
                                                <div class="card-body align-v-bottom">
                                                    <div class="holder">
                                                        ...
                                                        <p class="white"></p>
                                                        <!-- Button -->
                                                        <a href="{{ asset('images/cicmpdf/' . $day . '.' . $formattedMonth . '.' . substr($year, -2) . '.pdf') }}"
