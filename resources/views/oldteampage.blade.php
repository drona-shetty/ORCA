                      ...
                      <div class="bricklayer" data-columns="4">
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-eerishika"
                                  ...
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/Eerishika-Formal-Pic-490x560.jpg') }}"
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-ahana"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/1-490x560.png') }}" class="image"
                                          alt="Ahana Roy" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-goki"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/20210908_124307-490x560.jpg') }}"
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/1-490x560.png') }}" class="image"
                                              alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/Shinde_headshot.jpeg') }}" class="image"
                                              alt="Image name" />
                                      </div>
                                  </div>
                              </div>
