                      ...
                      <div class="bricklayer" data-columns="4">
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-eerishika"
                                  ...
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/Eerishika-Formal-Pic-490x560.jpg') }}" class="image"
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-rahul"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/Screenshot-2022-04-11-at-1.31.14-PM-490x560.png') }}"
                                          class="image"
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-ahana"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/1-490x560.png') }}" class="image" alt="Ahana Roy" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-omkar"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2022-09-06-at-9.23.38-AM-894x1024.jpeg') }}"
                                          class="image"
                                          alt="Omkar Bhole" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-ratish"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2022-11-03-at-12.28.32-490x560.jpeg') }}"
                                          class="image"
                                          alt="Ratish Mehta" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-goki"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/20210908_124307-490x560.jpg') }}" class="image"
                                          alt="Gokireddy Hima Bindu" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-shinde"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/Shinde_headshot.jpeg') }}" class="image"
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-bhuvesha"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2023-04-18-at-13.14.51-490x560.jpeg') }}"
                                          class="image"
                                          alt="B. K. Bhuvesha" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-bhaavya"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2023-03-15-at-10.58.35-PM-490x414.jpeg') }}"
                                          class="image"
                                          alt="Bhaavya Gupta" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-nisarg"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2023-04-03-at-11.33.41-490x560.jpeg') }}"
                                          class="image"
                                          alt="Nisarg Jani" />
                          ...
                          <div class="card">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#modal-debendra"
                                  class="item hover-zoom">
                                  <div class="image-wrapper small-shadow rounded-top">
                                      <img src="{{ asset('images/team/WhatsApp-Image-2023-04-18-at-13.56.06.jpeg') }}"
                                          class="image"
                                          alt="Debendra Sanyal" />
                                  ...
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/eerishika-pankaj') }}"
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/Eerishika-Formal-Pic-490x560.jpg') }}"
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/rahul-karan-reddy') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/Screenshot-2022-04-11-at-1.31.14-PM-490x560.png') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/1-490x560.png') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/omkar-bhole') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2022-09-06-at-9.23.38-AM-894x1024.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/dhananjay-shinde') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/Shinde_headshot.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2023-04-18-at-13.14.51-490x560.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/bhavya-gupta') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2023-03-15-at-10.58.35-PM-490x414.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/nisarg-jain') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2023-04-03-at-11.33.41-490x560.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/debendra-sanyal') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2023-04-18-at-13.56.06.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  <div class="col-12 col-md-7 align-v-center">
                                      <div class="holder">
                                          ...
                                          <div class="mt-social-1 mt-1">
                                              ...
                                              <a href="{{ asset('/author/ratish-mehta') }}"
                                                  class="button mt-1 outline rounded primary primary-hover hover-up">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/WhatsApp-Image-2022-11-03-at-12.28.32-490x560.jpeg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
                          ...
                          <div class="container">
                              <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-5">
                                      ...
                                      <div class="image-wrapper" data-lax="inertia-top">
                                          <img style="border-radius: 0.375rem;"
                                              src="{{ asset('images/team/20210908_124307-490x560.jpg') }}"
                                              class="image" alt="Image name" />
                                      </div>
                                  </div>
                              </div>
