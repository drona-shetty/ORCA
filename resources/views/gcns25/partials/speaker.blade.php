<div class="team-slider_cms_list swiper-wrapper">
    @php
        $speakers = App\Models\Event\Speaker::where('gcns', 2025)->paginate(6);
    @endphp
    @foreach ($speakers as $speaker)
        <div class="team-slider_cms_item swiper-slide">
            <a data-w-id="70526055-b2ed-4e7e-c089-c78f48128a1e"
                href="{{ url('pages/gcns2025/speaker/') }}/{{ $speaker->id }}"
                class="scroll-card w-inline-block">
                <div class="media-wrapper">
                    <img loading="lazy" src="{{ asset('images/event/speaker/' . $speaker->image) }}"
...
@if ($speakers->hasMorePages())
    <a class="rdf-button-1 editions w-button load-more" href="{{ url('pages/gcns2025/all-speakers') }}">View All</a>
@endif
