...
@section('content')
    ...
    <section id="first-section"
        style="background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url({{ asset('gcns25/images/Twitter-cover.jpg') }});background-size: cover;background-repeat: no-repeat;background-position: center;"
            ...
            <div class="faq-menu-wrapper">
                <div class="faq-menu-title">
                    <div class="break-left fullwidth">
                        ...
                        <h4 class="heading">{{ $concept->desc }}</h4>
                        <a href="https://orcasia.org/allfiles/ORCA_GCNS_2025_Agenda.pdf" download
