...
{{-- ================= SEO ================= --}}
@section('title', $speaker->name . ' | GCNS 2025 Speaker ORCA Conference')

@section('meta_description')
    Learn about {{ $speaker->name }}, {{ $speaker->designation }} at ORCA’s Global Conference on New Sinology 2025.
    {{ \Illuminate\Support\Str::limit(strip_tags($speaker->content), 140) }}
@endsection

@section('meta_keywords')
    GCNS 2025 speaker, ORCA speaker, {{ $speaker->name }}, China studies, Sinology conference
@endsection
...
@section('content')
    ...
    <meta name="twitter:title" content="{{ $speaker->name }} | GCNS 2025 Speaker">
    ...
    <section class="speaker-hero"
        ...
        <div class="speaker-hero-inner">
            <h1>{{ $speaker->name }}</h1>
            <h2>{{ $speaker->designation }} — ORCA Global Conference on New Sinology 2025</h2>
        </div>
        ...
        <div class="speaker-card">
            ...
            <div class="speaker-image">
                <img src="{{ url('images/event/speaker/' . $speaker->image) }}"
                    alt="{{ $speaker->name }} - GCNS 2025 Speaker" loading="lazy" decoding="async">
            </div>
