...
@section('content')
    ...
    @endphp
    <section data-poster-url="{{ asset('gcns25/videos/Untitled-design-poster-00001.jpg') }}"
        data-video-urls="{{ asset('gcns25/videos/Untitled-design-transcode.mp4') }},{{ asset('gcns25/videos/Untitled-design-transcode.webm') }}"
        ...
        class="video-section w-background-video w-background-video-atom"><video
            ...
            style="background-image:url(&quot;{{ asset('gcns25/videos/Untitled-design-poster-00001.jpg') }}&quot;)"
            muted="" playsinline="" data-wf-ignore="true" data-object-fit="cover">
            <source src="{{ asset('gcns25/videos/Untitled-design-transcode.mp4') }}" data-wf-ignore="true">
            <source src="{{ asset('gcns25/videos/Untitled-design-transcode.webm') }}" data-wf-ignore="true">
        </video>
        <div class="h1-title">
    ...
    <section class="features">
        ...
        <div class="headingtwo">
            ...
            <div data-w-id="0342cf17-6ce9-24ec-ad21-ce8afeaa85a4" class="break-right-1"><img loading="lazy"
                    src="{{ asset('gcns25/images/685d961c7776a97bf68b1767_box1.svg') }}" alt="" class="image">
            </div>
            <div data-w-id="0342cf17-6ce9-24ec-ad21-ce8afeaa85a6" class="break-right-2"><img loading="lazy"
                    src="{{ asset('gcns25/images/685d961c7776a97bf68b1765_box2.svg') }}" alt="" class="image">
            </div>
            ...
            <div class="break-right-5">
                <h1><a style="text-decoration: none;" href="https://orcasia.org/allfiles/GCNS_2023_Report.pdf" target="_blank">GCNS 2023 CONFERENCE REPORT</a></h1>
            </div>
        </div>
    </section>
    <!--FEATURES END-->
    ...
    <section class="media" id="media" style="height:auto">
        <div class="black-wrapper">
            ...
            @if ($media_files->hasMorePages())
                <a class="rdf-button-1 editions w-button load-more" href="{{ url('pages/gcns2023/all-media') }}">View
                    All</a>
            @endif
        </div>
    </section>
