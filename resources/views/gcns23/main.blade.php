...
<head>
    ...
    <link href="{{ asset('gcns25/css/normalize.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('gcns25/css/webflow.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('gcns25/css/parths-dandy-site-f0e9a3.webflow.css') }}" rel="stylesheet" type="text/css">
    <style>
    ...
    <link href="{{ asset('gcns25/css/custom.css') }}" rel="stylesheet" type="text/css">
...
<body class="body-2">
        ...
        <div class="rdf-container-1">
            <div class="div-block-3">
                <div class="rdf-wrap-1">
                    ...
                    <div class="rdf-wrap-6"><img src="{{ asset('gcns25/images/menu-alt-02-svgrepo-com.svg') }}"
                ...
                <div class="rdf-wrap-1">
                    <div class="rdf-wrap-4">
                        <a href="#" class="rdf-link-block-1 w-inline-block"><img
                                src="{{ asset('gcns25/images/orca-white_1.svg') }}"
                                loading="lazy" alt="" class="rdf-pic-1"></a>
                        <div class="rdf-decor-1"></div>
                        <a href="#" class="rdf-link-block-1 w-inline-block"><img
                                src="{{ asset('gcns25/images/gcns-ww.svg') }}"
                                loading="lazy" alt="" class="rdf-pic-1"></a>
                    </div>

                    <div class="rdf-wrap-6"><img src="{{ asset('gcns25/images/close-circle-svgrepo-com.svg') }}"
                            loading="lazy"
                ...
                <div class="footer_top v2">
                    <div id="w-node-cd4c017e-7d72-91de-9cda-4abfd4c0366f-53d1b8f2" class="footer_para-wrap v2 none">
                        <div class="rdf-wrap-4">
                            ...
                            <div class="rdf-decor-1"></div>
                            <a href="{{ url('pages/gcns2023') }}" class="rdf-link-block-1 w-inline-block"><img
                                    src="{{ asset('gcns25/images/gcns-ww.svg') }}" loading="lazy"
                                    alt="" class="rdf-pic-1" style="width: 10em;"></a>
                        </div>
                    </div>
                    ...
                    <div class="footer_icons">
                        ...
                        <a href="https://www.instagram.com/orca_researchchina?igsh=c2x5cXNnM3V3MGNm"
                            class="footer_icon-wrap w-inline-block"><img loading="lazy" width="25"
                                src="{{ asset('gcns25/images/insta.svg') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('gcns25/js/webflow.js') }}" type="text/javascript"></script>
