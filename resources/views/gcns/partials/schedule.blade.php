                                        ...
                                        <div class="question-block top w-dropdown-toggle"
                                            ...
                                            <div class="question-inner">
                                                ...
                                                <div class="div-block-8">
                                                    ...
                                                    ?>
                                                    <h3 class="cards-title schedule padding">{{ $convertedStartTime }}
                                                        - {{ $convertedEndTime }}</h3>
                                                    @if ($session->sessionTag != null)
                                                        <h3 class="cards-title schedule padding session">
                                                            <a href="https://orcasia.org/pages/gcns#collapse06"
                                                                class="link-2">{{ $session->sessionTag }}</a>
                                                        </h3>
                                                    @endif
                                                </div>
                                            </div>
