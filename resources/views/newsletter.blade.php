    ...
    <section class="shock-section has-overlay">
        <div class="banner">
            ...
            <div class="image-wrapper">
                <img src="assets/images/jpg/a-37.jpg" class="image vh-75 fit-cover"
            ...
            <div class="holder p-5 climb shadow rounded" data-bg-color="#201f25" data-lax="inertia-top">
                <div class="content max-w-85 scheme-2">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item has-icon">
                                    <a href="{{ asset('/') }}" class="breadcrumb-link"><i
                                            class="fa-solid fa-house icon"></i><span class="text">Home</span></a>
                                </li>
                                <li class="breadcrumb-item">
                                    <a href="{{ asset('category/cicm') }}" class="breadcrumb-link">Blog</a>
                                </li>
                    ...
                    <p>Design is a broad concept that represents the process of creating products based on technical and
                        aesthetic excellence, with the aim of <mark class="animated-underline primary-50 text-white">solving
                            problems</mark> and adding value. Good design delivers the best possible user experience.</p>
                    <p>Design is a thought process that comprises the creation of products to solve problems, including
                        functional and <strong>aesthetic aspects</strong>.</p>
                    <p>This is the most objective definition possible for the concept, which encompasses numerous forms of
                        idealization, conception, development and specification of objects.</p>

                    <!-- Paragraph -->
                    <h3>Some of the types of designs that exist</h3>
                    <ul>
                        <li><strong>Graphic design</strong> is the use of images, texts and illustrations for visual
                            communication.</li>
                        <li><strong>Game design</strong> focused on the development and <a href="#"><u>creation of
                                    games</u></a>.</li>
                        <li><strong>Design thinking</strong> can be defined as the way of design thinking applied to the
                            solution of challenges and innovation in business:
                            <ul>
                        ...
                        <li><strong>Product design</strong>, works with the <mark
                                class="animated-underline primary-50 text-white">creation of objects</mark> focused on
                            solving problems.</li>
                        <li><strong>Web design</strong> is the area that covers the creation of interfaces for software,
                            websites, platforms and applications.</li>
                        <li><strong>Interior design</strong> is the area responsible for planning, creating and executing
                            indoor projects.</li>
                    </ul>

                    <!-- Paragraph -->
                    <h3>The history of design</h3>
                    <p>If we take the term literally, our ancestors already practiced design when creating their chipped
                        stone tools. However, to facilitate understanding, let's place the concept in our age.</p>
                    <p>In this case, who deserves the title of first designer in history is <a href="#"><u>Leonardo Da
                                Vinci</u></a>.</p>
                    <p>The genius used design principles to design visionary inventions that revolutionized humanity and
                        propelled science forward.</p>
                    ...
                    <!-- Paragraph -->
                    <p>Design is fundamental because it optimizes human creation, combining aesthetics with functionality.
                        It is a process capable of adding value and generating more efficient, comfortable, safe and <mark
                            class="animated-underline primary-50 text-white">beautiful solutions</mark>.</p>
                    <p>Proof of this is that common sense equates design with something beautiful and well done. For
                        companies, design is one of the key success factors, from <strong>product development</strong> to
                        customer value delivery.</p>
                    ...
                    <!-- Paragraph -->
                    <p>It's not just about enchanting the product's look, but thinking about the entire process of use and
                        arriving at the best possible solution.</p>
                    <p>For this, the designer transforms ideas into products that actually solve problems, designed and
                        executed in the smallest details.</p>
                    <h3>Is design considered an art?</h3>
                    <p>Personally, I usually say that design is the bridge between what already exists and what is possible
                        to imagine and do.</p>
                    <p>Therefore, it is such a complex concept, which goes through art, business, culture, aesthetics,
                                ...
                                <div class="bricklayer" data-columns="3">
                                    <a href="assets/images/jpg/d-1.jpg" class="item lightbox-link">
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-1.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                    <a href="assets/images/jpg/d-2.jpg" class="item lightbox-link">
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-2.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                    <!-- Video -->
                                    <a href="https://vimeo.com/222990241" class="item active lightbox-link">
                                        ...
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-3.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                    <a href="assets/images/jpg/d-4.jpg" class="item lightbox-link">
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-4.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                    <a href="assets/images/jpg/d-5.jpg" class="item lightbox-link">
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-5.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                    <a href="assets/images/jpg/d-6.jpg" class="item lightbox-link">
                                        <div class="image-wrapper shadow rounded hover-zoom-rotate">
                                            <div class="overlay black-50"></div>
                                            <img src="assets/images/jpg/d-6.jpg" class="image rounded shadow"
                                                alt="This is an example description for this item." />
                                        </div>
                                    </a>
                                </div>
                    ...
                    <p>As we have seen, it is not a simple term, as it concerns a process, science, profession and even
                        attributes of everything we know.</p>
                    <p>No wonder you are surrounded by examples of design: the page of this blog, the decoration of your
                        office, the model of your shirt and even the shape of your chair. That's why design is so important.
                    </p>
                            ...
                            <div class="post-reference" data-lax="inertia-top">
                                <div class="post-reference-container">
                                    ...
                                    <div class="text-wrapper">
                                        <h5 class="title"><mark class="animated-underline primary-50">John Young</mark>
                                        </h5>
                                        <p class="description">Co-founder of the Company. The Wall Street Journal named him
                                            the biggest influencer on the web.</p>
                                        <cite title="Source Title">Author of the article "Why design matters to our
                                            lives".</cite>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="comments">
                        ...
                        <div class="comments-wrapper">
                            ...
                            <div id="comment-1" class="comment">
                                ...
                                <div class="comment-content">
                                    <p>Hello, this theme is really amazing! It has many features that make my job as a
                                        developer much easier. I'm sure my clients will love to see the final result of this
                                        project.</p>
                                </div>
                            ...
                            <div id="comment-2" class="comment">
                                ...
                                <div class="comment-content">
                                    <p>مرحبًا ، هذا المظهر رائع حقًا! يحتوي على العديد من الميزات التي تجعل عملي كمطور أسهل
                                        بكثير. أنا متأكد من أن عملائي سيحبون رؤية موقع الويب الذي أقوم ببنائه لهم.</p>
                                </div>
                                <div class="comment-action">
                                    <!-- Button -->
                            ...
                            <div id="comment-3" class="comment">
                                ...
                                <div class="comment-content">
                                    <p>Hola, este tema es realmente increíble! Tiene muchas características que hacen que mi
                                        trabajo como desarrollador sea mucho más fácil. Estoy seguro de que a mis clientes
                                        les encantará ver el sitio web que estoy creando para ellos.</p>
                                </div>
                                <div class="comment-action">
                                    <!-- Button -->
                            ...
                            <div id="comment-4" class="comment">
                                ...
                                <div class="comment-content">
                                    <p>Привет, эта тема действительно потрясающая! Он имеет множество функций, которые
                                        значительно облегчают мою работу как разработчика. Я уверен, что моим клиентам
                                        понравится конечный результат этого проекта.</p>
                                </div>
                                <div class="comment-action">
                                    <!-- Button -->
                        ...
                        <div class="form-area scheme-2 primary">
                            <h3>Leave a reply</h3>
                            <p>To write a comment you need to <a href="#" target="_blank"><u>login</u></a> to your
                                account.</p>
                            <form class="form-fields needs-validation" novalidate="novalidate">
                                <div class="form-row row">
                                    <div class="form-col col-12">
                                        <textarea class="form-control rounded-3 form-textarea" id="InputCompactExampleMessage" rows="3"
