...
<div id="modalOverlay" class="modal-overlay">
    <div class="modal">
        ...
        <h2 style="margin-bottom:15px; text-align:center; color:var(--orca-red);">Registrations for GCNS are now closed
        </h2>
        <!-- <form method="POST" action="{{ route('scheduleRegistration') }}">
            ...
            <div>
                <label>How did you come to know about GCNS 2026?</label>
            ...
            <div class="full-width note">
                <p>
                    <strong>*Kindly note that the registration is only for Day 1 (23rd September 2026).
