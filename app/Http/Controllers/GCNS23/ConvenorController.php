...
class ConvenorController extends Controller
{
    ...
    {
        $convenors = Convenor::where('gcns', 2023)->orderBy('id', 'desc')->paginate(10);
        return view('admin.gcns23.convenor.listing', compact('convenors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns23/convenors')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns23.convenor.edit', compact('convenor'));
    }
