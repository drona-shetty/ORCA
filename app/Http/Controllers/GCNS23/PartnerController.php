...
class PartnerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.gcns23.partner.listing', compact('partners'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns23/partner')
    ...
    {   
        $graphs = Partner::orderBy('id', 'asc')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns23.partner.edit', compact('partner'));
    }
