...
class AboutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.gcns23.about.listing', compact('abouts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns23/about')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns23.about.edit', compact('about'));
    }
