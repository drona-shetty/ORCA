...
use App\Models\Gcns\Registeration;
...
class RegisterationController extends Controller
{
    ...
    {
        $registerations = Registeration::orderBy('id', 'asc')->paginate(15);
        return view('admin.gcns23.registeration.listing', compact('registerations'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('yn-admin/gcns23/registeration')
