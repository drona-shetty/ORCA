...
class PartnerController extends Controller
{
    ...
    {
        $partners = Partner::where('gcns', 2026)->orderBy('id', 'desc')->paginate(10);
        return view('admin.gcns26.partner.listing', compact('partners'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/partner')
    ...
    {
        $graphs = Partner::where('gcns', 2026)->orderBy('id', 'asc')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.partner.edit', compact('partner'));
    }
