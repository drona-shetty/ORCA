...
class MediaController extends Controller
{
    ...
    {
        $mediaFiles = Media::where('gcns', 2026)->orderBy('sequence_no', 'asc')->paginate(10);

        return view('admin.gcns26.media.listing', compact('mediaFiles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/media')->with('success', 'Your Media file is uploaded successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.media.edit', compact('mediaFile'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('yn-admin/gcns26/media')->with('success', 'Media file updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('yn-admin/gcns26/media')->with('success', 'Media File deleted successfully');
    }
    ...
    {
        if ($request->ajax()) {
            $media_files = Media::where('gcns', 2026)
                ->orderBy('sequence_no', 'asc')
                ->paginate(6, ['*'], 'page', $request->page);

            return view('gcns26.partials.media', compact('media_files'))->render();
        }
    }
}
