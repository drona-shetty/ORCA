...
class ConvenorController extends Controller
{
    ...
    {
        $convenors = Convenor::where('gcns', 2026)->orderBy('id', 'desc')->paginate(10);
        return view('admin.gcns26.convenor.listing', compact('convenors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/convenors')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.convenor.edit', compact('convenor'));
    }
