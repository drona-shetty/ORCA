...
class AboutController extends Controller
{
    ...
    {
        $abouts = About::where('gcns', 2026)->orderBy('id', 'desc')->get();
        return view('admin.gcns26.about.listing', compact('abouts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/about')
    ...
    {
        $graphs = About::where('gcns', 2026)->orderBy('id', 'asc')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.about.edit', compact('about'));
    }
