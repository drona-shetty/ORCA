...
class SpeakerController extends Controller
{
    ...
    {
        $speakers = Speaker::where('gcns', 2026)->orderBy('id', 'desc')->paginate(15);
        return view('admin.gcns26.speaker.listing', compact('speakers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/speaker')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.speaker.edit', compact('speaker'));
    }
    ...
    public function getSpeakerData($id)
    {
        ...
        if ($speaker) {
            return view('gcns26.speaker', compact('speaker'));
        } else {
            return redirect('pages/gcns2026');
        }
    }
}
