...
class ScheduleController extends Controller
{
    ...
    {
        $schedules = Schedule::where('gcns', 2026)->orderBy('id', 'asc')->get();
        return view('admin.gcns26.schedule.listing', compact('schedules'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/schedule')
    ...
    {
        $speakers = Speaker::where('gcns', 2026)->orderBy('id', 'desc')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns26.schedule.edit', compact('schedule', 'scheduleSession'));
    }
    ...
    {
        $schedule = Schedule::where('id', $id)->first();
        return view('admin.gcns26.sessions.add', compact('schedule'));
    }
    ...
    public function sessionCreate(Request $request)
    {
        ...
        return redirect('yn-admin/gcns26/schedule/' . $request['scheduleId'] . '/edit')
    ...
    public function sessionEdit($scheduleId, $sessionId)
    {
        ...
        if ($schedule) {
            ...
            return view('admin.gcns26.sessions.edit', compact('schedule', 'sessionData'));
        } else {
            return redirect('yn-admin/gcns26/schedule');
        }
    }
    ...
    public function sessionDestroy($scheduleId, $sessionId)
    {
        ...
        return redirect('yn-admin/gcns26/schedule/' . $scheduleId . '/edit')
