...
class SpeakerController extends Controller
{
    ...
    {
        $speakers = Speaker::where('gcns', 2025)->orderBy('id', 'desc')->paginate(15);
        return view('admin.gcns.speaker.listing', compact('speakers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns/speaker')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns.speaker.edit', compact('speaker'));
    }
    ...
    public function getSpeakerData($id)
    {
        ...
        if($speaker)
        {
            return view('gcns25.speaker', compact('speaker'));
        }else{
            return redirect('pages/gcns2025');
        }
    }
}
