...
class ConvenorController extends Controller
{
    ...
    {
        $convenors = Convenor::where('gcns', 2025)->orderBy('id', 'desc')->paginate(10);
        return view('admin.gcns.convenor.listing', compact('convenors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns/convenors')
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns.convenor.edit', compact('convenor'));
    }
