...
class ScheduleController extends Controller
{
    ...
    {
        $schedules = Schedule::where('gcns', 2025)->orderBy('id', 'asc')->get();
        return view('admin.gcns.schedule.listing', compact('schedules'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/gcns/schedule')
    ...
    {   
        $speakers = Speaker::where('gcns', 2025)->orderBy('id', 'desc')->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.gcns.schedule.edit', compact('schedule','scheduleSession'));
    }
    ...
    {   
        $schedule = Schedule::where('id', $id)->first();
        return view('admin.gcns.sessions.add', compact('schedule'));
    }
    ...
    {   
        ...
        return redirect('yn-admin/gcns/schedule/'.$request['scheduleId'].'/edit')
    ...
    public function sessionEdit($scheduleId,$sessionId)
    {
        ...
        if($schedule)
        {
            ...
            return view('admin.gcns.sessions.edit', compact('schedule','sessionData'));
        }else{
            return redirect('yn-admin/gcns/schedule');
        }
    }
    ...
    public function sessionDestroy($scheduleId,$sessionId)
    {
        ...
        return redirect('yn-admin/gcns/schedule/'.$scheduleId.'/edit')
