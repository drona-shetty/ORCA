...
class MediaController extends Controller
{
    ...
    {
        $mediaFiles = Media::where('gcns', 2024)->orderBy('sequence_no', 'asc')->paginate(10);
    ...
    public function store(Request $request)
    {
        $request->validate([
            'sequence' => 'required',
            'fileToUpload' => 'required|mimes:jpeg,png,jpg', // Adjust the allowed file types and size as per your requirements
        ]);
        $request = request()->all();
        ...
        return redirect('yn-admin/event/media')->with('success', 'Your Media file is uploaded successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('yn-admin/event/media')->with('success', 'Media file updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('yn-admin/event/media')->with('success', 'Media File deleted successfully');
    }
    ...
    {
        if ($request->ajax()) {
            $media_files = Media::where('gcns', 2024)->orderBy('sequence_no', 'asc')
                                ->paginate(6, ['*'], 'page', $request->page);
    
            return view('gcns.partials.media', compact('media_files'))->render();
        }
    }
}
