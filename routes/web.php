...
Route::get('/migrate-article-authors', function () {
    ...
    $articles = Article::select('id','author_id')->get();
    ...
    foreach ($articles as $article) {
        ...
        foreach ($authors as $authorId) {
            ...
            DB::table('article_user')->updateOrInsert(
                [
    ...
    return "Author migration completed.";
});
...
Route::get('/migrate-tags', function () {
    ...
    return "Tag migration completed.";
});
    ...
    Route::prefix('yn-admin')->group(function () {
        ...
        Route::prefix('consultancy')->group(function(){
            Route::controller(ConsultancyController::class)->group(function(){
                Route::get('/', 'index');
                Route::get('/{id}', 'view')->name('consultancy.view');
